                ...
                while not (no_of_cores_found is True and core_clock_found is True and l2_cache_found is True
                    ...
                    for i, column in enumerate(cpu_row.find_all('td')):
                        if re.search(r'^[0-9][0-9]?$\b',
                            ...
                            core_clock = core_clock.replace('GHz', '').strip()
